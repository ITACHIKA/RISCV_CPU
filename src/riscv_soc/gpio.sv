...
// Only decode lower 16 bits of the address for GPIO
// Since address resolver already generates appropriate write enable and read enable signals, we don't need to check complete address range here.
...
always_ff @(posedge clk) begin
    ...
    if(gpio_wren) begin
        if(gpio_addr[12:0] == 13'h0000) begin
...
always_ff @(posedge clk) begin
    ...
    if(gpio_rden) begin
        ...
        else if(gpio_addr[12:0] == 13'h0004) begin
            rdata <= btn_reg;
        end
    end
end
